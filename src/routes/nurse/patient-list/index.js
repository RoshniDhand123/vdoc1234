...
import { getPatientRequestList ,getPatientReport} from "../../../services/apis/index";
			...
			<>
			    {open && (
					<ModalComponent open={open} alongSidebar={true}>
						<Detail buttonAction={this.getReport} prevReport={patient_reportInfo} getRequestList={this.getRequestList}/>
					</ModalComponent>
				)}
